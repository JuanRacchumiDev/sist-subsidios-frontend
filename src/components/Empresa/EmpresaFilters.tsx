...
interface EmpresaFilterProps {
  onSearch: (filters: EmpresaFiltersData) => void;
}

export interface EmpresaFiltersData {
  search: string;
}

export const EmpresaFilters: React.FC<EmpresaFilterProps> = ({ onSearch }) => {
  const [filters, setFilters] = useState<EmpresaFiltersData>({
    search: "",
  });
