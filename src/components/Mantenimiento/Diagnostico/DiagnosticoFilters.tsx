...
interface DiagnosticoFilterProps {
  onSearch: (filters: DiagnosticoFiltersData) => void;
}

export interface DiagnosticoFiltersData {
  search: string;
}

export const DiagnosticoFilters: React.FC<DiagnosticoFilterProps> = ({
  onSearch,
}) => {
  const [filters, setFilters] = useState<DiagnosticoFiltersData>({
    search: "",
  });
