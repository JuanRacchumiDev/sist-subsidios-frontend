...
interface CargoFilterProps {
  onSearch: (filters: CargoFiltersData) => void;
}

export interface CargoFiltersData {
  search: string;
}

export const CargoFilters: React.FC<CargoFilterProps> = ({ onSearch }) => {
  const [filters, setFilters] = useState<CargoFiltersData>({
    search: "",
  });
