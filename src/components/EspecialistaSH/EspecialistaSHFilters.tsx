...
interface EspecialistaSHFilterProps {
  onSearch: (filters: EspecialistaSHFiltersData) => void;
}

export interface EspecialistaSHFiltersData {
  search: string;
  documento: string;
}

export const EspecialistaSHFilters: React.FC<EspecialistaSHFilterProps> = ({
  onSearch,
}) => {
  const [filters, setFilters] = useState<EspecialistaSHFiltersData>({
    search: "",
    documento: "",
  });
