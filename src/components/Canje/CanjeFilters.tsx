...
interface CanjeFilterProps {
  onSearch: (filters: CanjeFiltersData) => void;
}
...
export interface CanjeFiltersData {
...
export const CanjeFilters: React.FC<CanjeFilterProps> = ({ onSearch }) => {
  ...
  const [filters, setFilters] = useState<CanjeFiltersData>({
  ...
  const handleSelectChange = (key: keyof CanjeFiltersData, value: string) => {
