...
interface TrabajadorSocialFilterProps {
  onSearch: (filters: TrabajadorSocialFiltersData) => void;
}

export interface TrabajadorSocialFiltersData {
  search: string;
  documento: string;
}

export const TrabajadorSocialFilters: React.FC<TrabajadorSocialFilterProps> = ({
  onSearch,
}) => {
  const [filters, setFilters] = useState<TrabajadorSocialFiltersData>({
    search: "",
    documento: "",
  });
