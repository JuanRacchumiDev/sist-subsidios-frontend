...
interface EspecialistaClienteFilterProps {
  onSearch: (filters: EspecialistaClienteFiltersData) => void;
}

export interface EspecialistaClienteFiltersData {
  search: string;
  documento: string;
}

export const EspecialistaClienteFilters: React.FC<
  EspecialistaClienteFilterProps
> = ({ onSearch }) => {
  const [filters, setFilters] = useState<EspecialistaClienteFiltersData>({
    search: "",
    documento: "",
  });
